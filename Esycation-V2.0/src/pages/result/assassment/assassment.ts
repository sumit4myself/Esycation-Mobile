...
export class AssassmentComponent extends BaseComponent {
  ...
  onPublish() {
    ...
    this.assessmentService.publishAssessment(this.studentAssessment).subscribe(
      data => {
        console.log("data==", data);
        this.commonServices.presentToast(
          "Assessment publish successfully",
          null,
          "success"
        );
        this.commonServices.onDismissAll();
  ...
  onDraft() {
    ...
    this.assessmentService.draftAssessment(this.studentAssessment).subscribe(
      data => {
        console.log("data==", data);
        this.commonServices.presentToast(
          "Assessment draft successfully",
          null,
          "success"
        );
        this.commonServices.onDismissAll();
