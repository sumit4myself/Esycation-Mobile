...
export class GuardianDashboardComponent {
    ...
    constructor(private navContrle:NavController,
     ...
     fetchResultStatStats(){
        ...
        // this.approvelService.findPending(this.session.findUserId())
        this.approvelService.findStudentResultStatistic(this.currentSelectedStudent)
        .subscribe(data=>{
            console.log("RESULT = ",data)
            data = {"data":[{"id":1,"name":"Exam 1","data":[{"id":1,"name":"Subject 1","data":91},{"id":1,"name":"Subject 2","data":22},{"id":1,"name":"Subject 3","data":84},{"id":1,"name":"Subject 4","data":79},{"id":1,"name":"Subject 5","data":34}]},{"id":2,"name":"Exam 2","data":[{"id":2,"name":"Subject 1","data":93},{"id":2,"name":"Subject 2","data":14},{"id":2,"name":"Subject 3","data":19},{"id":2,"name":"Subject 4","data":11},{"id":2,"name":"Subject 5","data":19}]},{"id":3,"name":"Exam 3","data":[{"id":3,"name":"Subject 1","data":80},{"id":3,"name":"Subject 2","data":97},{"id":3,"name":"Subject 3","data":57},{"id":3,"name":"Subject 4","data":21},{"id":3,"name":"Subject 5","data":81}]},{"id":4,"name":"Exam 4","data":[{"id":4,"name":"Subject 1","data":83},{"id":4,"name":"Subject 2","data":57},{"id":4,"name":"Subject 3","data":92},{"id":4,"name":"Subject 4","data":60},{"id":4,"name":"Subject 5","data":14}]},{"id":5,"name":"Exam 5","data":[{"id":5,"name":"Subject 1","data":65},{"id":5,"name":"Subject 2","data":79},{"id":5,"name":"Subject 3","data":22},{"id":5,"name":"Subject 4","data":15},{"id":5,"name":"Subject 5","data":45}]}]};
            try{
     ...
     fetchAttendanceStats(){
        ...
        this.approvelService.findStudentAttendanceStatistic(this.currentSelectedStudent,fromDate,toDate)
        .subscribe(data=>{
            console.log(data)
            try{
    ...
    studentSlideChanged(){
        ...
        if(this.studentListBasedonGuardian&&this.studentListBasedonGuardian.length>0&&this.studentListBasedonGuardian[slideIndex]&&this.studentListBasedonGuardian[slideIndex].name&&this.studentListBasedonGuardian[slideIndex].name.length>0){
            this.currentSelectedStudent = this.studentListBasedonGuardian[slideIndex].id;
            this.currentSelectedStudentName = this.studentListBasedonGuardian[slideIndex].name;
            this.setUpDashboard();
        }
    }
    ...
    findStudentListBasedOnGuardianId(){
        ...
        this.leaveService.findStudentListByGuardianIds(this.session.findRemote()).subscribe(data=>{
    ...
    getTimeTableBasedOnStudentId(){
        this.leaveService.findTimeTableByStudentId(this.currentSelectedStudent).subscribe(
            data=>{
                this.timeTable = data;
        },error=>{
            console.error(error);
    ...
    getTeacherDeatilsBasedOnStudentId(){
        this.leaveService.findTeacherDetailsByStudentId(this.currentSelectedStudent).subscribe(
            data=>{
