...
export class FileDownlaodComponent {
  ...
  dwonLoadPath: String = ServerConfig.browseFilePath();

  @Input() public fileId: number = null;

  @Input("fileName") public fname: any = null;
