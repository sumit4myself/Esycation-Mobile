...
/**
 * Api services for the `Feed` model.
 */
@Injectable()
export class FeedApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createManyComments(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Feeds/:id/comments";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyLikes(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Feeds/:id/likes";
    let _routeParams: any = {
