...
import { NavController, AlertController, LoadingController, Loading, PopoverController, ViewController, ModalController } from 'ionic-angular';
...
@Component({
  selector: 'news-classic',
  templateUrl: 'news-classic.html'
})

export class NewsClassicComponent implements OnInit {
