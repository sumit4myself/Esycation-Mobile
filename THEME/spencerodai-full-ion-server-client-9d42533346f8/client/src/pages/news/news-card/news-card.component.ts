...
import { NavController, LoadingController, AlertController, Loading, PopoverController, ModalController } from 'ionic-angular';
  ...
  */
  addFeed() {
    ...
    modal.onDidDismiss((_feed: Feed) => {
      if (_feed) {
        this.reference.upsert(_feed).subscribe(() =>
